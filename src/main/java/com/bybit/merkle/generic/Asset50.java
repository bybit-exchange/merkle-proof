...
public enum Asset50 {
    ...
    // change EOS to A from release 20250619
    A((short) 12, 8, RoundingMode.DOWN, true),
    ETH((short) 13, 8, RoundingMode.DOWN, true),
    // from release 20250114
    // FTM((short) 14, 8, RoundingMode.DOWN, true),
    S((short) 14, 8, RoundingMode.DOWN, true),
    ...
    // from release 20260722
    GRAM((short) 43, 8, RoundingMode.DOWN, true),
    XAUT((short) 44, 8, RoundingMode.DOWN, true),
    HYPE((short) 45, 8, RoundingMode.DOWN, true),
    STABLE((short) 46, 8, RoundingMode.DOWN, true),
    ENA((short) 47, 8, RoundingMode.DOWN, true),
    ARB((short) 48, 8, RoundingMode.DOWN, true),
    ASTER((short) 49, 8, RoundingMode.DOWN, true),
    ONDO((short) 50, 8, RoundingMode.DOWN, true),
    AAVE((short) 51, 8, RoundingMode.DOWN, true),
    USD1((short) 52, 8, RoundingMode.DOWN, true);
    ...
    Asset50(short id, int scale, RoundingMode mode, boolean online) {
        this.id = id;
        this.scale = scale;
        this.mode = mode;
        this.online = online;
    ...
    public static List<Asset50> getBalances() {
        return Arrays.stream(values()).filter(Asset50::isOnline).collect(Collectors.toList());
    }
}
