...
public enum Asset40V4 {
    ...
    Asset40V4(short id, int scale, RoundingMode mode, boolean online) {
        this.id = id;
        this.scale = scale;
        this.mode = mode;
        this.online = online;
    ...
    public static List<Asset40V4> getBalances() {
        return Arrays.stream(values()).filter(Asset40V4::isOnline).collect(Collectors.toList());
    }
}
