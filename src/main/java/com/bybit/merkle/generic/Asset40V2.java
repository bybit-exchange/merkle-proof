...
public enum Asset40V2 {
    ...
    Asset40V2(short id, int scale, RoundingMode mode, boolean online) {
        this.id = id;
        this.scale = scale;
        this.mode = mode;
        this.online = online;
    ...
    public static List<Asset40V2> getBalances() {
        return Arrays.stream(values()).filter(Asset40V2::isOnline).collect(Collectors.toList());
    }
}
