...
public enum Asset40 {
    ...
    RNDR((short) 38, 8, RoundingMode.DOWN, true),
    ...
    Asset40(short id, int scale, RoundingMode mode, boolean online) {
        this.id = id;
        this.scale = scale;
        this.mode = mode;
        this.online = online;
    ...
    public static List<Asset40> getBalances() {
        return Arrays.stream(values()).filter(Asset40::isOnline).collect(Collectors.toList());
    }
}
