...
public enum AssetMnt20 {
    ...
    AssetMnt20(short id, int scale, RoundingMode mode, boolean online) {
        this.id = id;
        this.scale = scale;
        this.mode = mode;
        this.online = online;
    ...
    public static List<AssetMnt20> getBalances() {
        return Arrays.stream(values()).filter(AssetMnt20::isOnline).collect(Collectors.toList());
    }
}
