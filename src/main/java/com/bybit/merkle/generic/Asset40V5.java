...
public enum Asset40V5 {
    ...
    Asset40V5(short id, int scale, RoundingMode mode, boolean online) {
        this.id = id;
        this.scale = scale;
        this.mode = mode;
        this.online = online;
    ...
    public static List<Asset40V5> getBalances() {
        return Arrays.stream(values()).filter(Asset40V5::isOnline).collect(Collectors.toList());
    }
}
